class EventsController < ApplicationController
  before_action :set_event, only: %i[show edit update destroy loop_routes reject join_waitlist leave_waitlist convert_waitlist_to_attendance refuse_waitlist confirm_waitlist decline_waitlist]
