# Erreur #011 : Password Reset PUT /users/password (mot de passe trop court)
...
- **Commande pour reproduire** :
  ```bash
  docker exec grenoble-roller-dev bundle exec rspec ./spec/requests/passwords_spec.rb:104
  ```
