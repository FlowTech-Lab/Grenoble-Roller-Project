# Erreur #008 : PasswordsController GET #edit
...
- **Ligne** : 212
- **Test** : `affiche le formulaire de réinitialisation` (avec un token valide)
- **Commande pour reproduire** :
  ```bash
  docker exec grenoble-roller-dev bundle exec rspec ./spec/controllers/passwords_controller_spec.rb:212
  ```
...
AbstractController::ActionNotFound:
  Could not find devise mapping for path "/users/password/edit?reset_password_token=BkeykEb4VR1pz3sqzm3L".
...
# ./spec/controllers/passwords_controller_spec.rb:213:in 'block (4 levels) in <top (required)>'

Finished in 1.32 seconds (files took 1.63 seconds to load)
1 example, 1 failure
```
