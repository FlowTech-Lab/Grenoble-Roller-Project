# Erreur #004 : PasswordsController PUT #update (mot de passe trop court)
...
- **Ligne** : 125
- **Test** : `rejette un mot de passe trop court` (avec vérification Turnstile réussie)
- **Commande pour reproduire** :
  ```bash
  docker exec grenoble-roller-dev bundle exec rspec ./spec/controllers/passwords_controller_spec.rb:125
  ```
...
# ./spec/controllers/passwords_controller_spec.rb:126:in 'block (4 levels) in <top (required)>'

Finished in 1.47 seconds (files took 1.59 seconds to load)
1 example, 1 failure
```
