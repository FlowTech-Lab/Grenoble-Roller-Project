# Erreur #155-156 : Models Order (2 erreurs)
...
- **Lignes** : 7, 13
- **Tests** :
  1. Ligne 7 : `Order belongs to user and optionally to payment`
  2. Ligne 13 : `Order destroys order_items when destroyed`
...
- 🔍 Problème probable avec les associations ou callbacks
