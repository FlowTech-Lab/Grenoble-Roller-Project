# Erreur #005 : PasswordsController PUT #update (Turnstile échouée)
...
- **Commande pour reproduire** :
  ```bash
  docker exec grenoble-roller-dev bundle exec rspec ./spec/controllers/passwords_controller_spec.rb:160
  ```
