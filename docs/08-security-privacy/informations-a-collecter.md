...
### 2.1 Identifiants (si activité commerciale déclarée)

| Champ | Réponse |
|-------|---------|
| **Numéro SIRET** | ________________________ |
| **Code APE (Activité Principale Exercée)** | ________________________ |
| **Numéro TVA intracommunautaire** | ________________________ (si applicable) |
...
- Consulter les factures d'hébergement
- Vérifier le contrat d'hébergement
- Consulter le `whois` du domaine
- Vérifier les variables d'environnement du projet

**Hébergeurs courants** : OVH, Scaleway, AWS, Heroku, Railway, Render, etc.

---

## 4. BOUTIQUE - MODALITÉS DE VENTE
...
| **Garantie commerciale supplémentaire** | ________________________ (optionnel) |

---

## 5. PAGE CONTACT

### 5.1 Coordonnées Complètes
...
### 6.1 Cookies et Données

| Question | Réponse |
|----------|---------|
| **Cookies utilisés actuellement** | ☐ Cookies de session (Devise) ✅<br>☐ Cookies "Remember me" ✅<br>☐ Cookies analytiques (Google Analytics, etc.)<br>☐ Cookies publicitaires |
| **Durée de conservation des données** | Comptes : ________________________<br>Commandes : 10 ans ✅ (obligatoire comptable)<br>Cookies : ________________________ |

### 6.2 Médiation et Litiges
...
1. **Confidentialité** : Ce document contient des informations sensibles. À conserver en sécurité.

2. **Mise à jour** : Ces informations doivent être mises à jour en cas de changement :
   - Nouveau président
   - Changement d'adresse
   - Changement d'hébergeur
   - Modification des modalités de vente

3. **Validation juridique** : Il est **fortement recommandé** de faire valider ces informations et les pages légales par un professionnel du droit avant mise en ligne.

4. **Traçabilité** : Conserver une copie de ce formulaire complété pour référence future.
...
- **Obligations légales** : Service-Public.fr, CNIL, France Num
