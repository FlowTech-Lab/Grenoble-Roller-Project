...
minio:
  ...
  endpoint: http://minio:9000  # Configuration unique pour tous les environnements
                                # Utilise le nom du service Docker (réseau interne uniquement)
                                # MinIO n'est PAS exposé à l'extérieur du réseau Docker
```
