...
**Fichier actuel** : 
- `app/controllers/admin_panel/dashboard_controller.rb` (existe déjà, basique)
- `app/views/admin_panel/dashboard/index.html.erb` (existe déjà, basique)
...
- [ ] Intégrer avec Inventories (si disponible)
- [ ] Intégrer avec Initiations (si disponible)
- [ ] Ajouter graphique ventes
