...
**Docs layout:** numbered sections `docs/00-overview/` → `docs/11-templates/`. There is no top-level `docs/README.md` — use [`docs/00-overview/README.md`](docs/00-overview/README.md) as the index.
...
Create an ADR from [`docs/11-templates/adr-template.md`](docs/11-templates/adr-template.md) before large refactors or new infrastructure.
